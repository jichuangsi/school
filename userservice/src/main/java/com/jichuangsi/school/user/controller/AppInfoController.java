...
public class AppInfoController {
    ...
    public ResponseModel<AppInfoModule> login(@ModelAttribute UserInfoForToken userInfo, @RequestBody AppInfoQueryModule appInfoQueryModule) throws UserServiceException{
