...
public interface QuestionRepository extends MongoRepository<Question, String>, QuestionExtraRepository{
   ...
   // List<Question> findBySubjectIdAndUpdateTimeIsGreaterThan(String subjectId,Long createTime);
   //findByClassIdAndStatusAndEndTimeGreaterThanAndTeacherIdAndSubjectNameLikeOrderByCreateTime
}
