...
import com.jichuangsi.school.homeworkservice.repository.QuestionExtraRepository;
...
public class QuestionExtraRepositoryImpl implements QuestionExtraRepository {
    ...
    @Override
    public List<Question> findQuestionsByHomeworkId(String homeworkId) {
        /**
        ...
        Aggregation agg = Aggregation.newAggregation(
                match(Criteria.where("_id").is(homeworkId)),
        ...
        return mongoTemplate.aggregate(agg, Homework.class,Question.class).getMappedResults();
    }
}
