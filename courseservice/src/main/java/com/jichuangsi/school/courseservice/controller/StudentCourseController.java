...
public class StudentCourseController {
	...
	public ResponseModel<AnswerForStudent> sendSubjectPic(@RequestParam MultipartFile file, @ModelAttribute UserInfoForToken userInfo) throws StudentCourseServiceException{
		try{
