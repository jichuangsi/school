package com.jichuangsi.school.testservice.controller.advice;
...
public class CommonControllerAdvice {
	...
	@ExceptionHandler({TeacherTestServiceException.class, StudentTestServiceException.class, FileServiceException.class})
