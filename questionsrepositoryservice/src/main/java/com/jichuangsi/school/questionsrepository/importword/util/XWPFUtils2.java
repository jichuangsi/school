...
public class XWPFUtils2 {

    public static void readImageInParagraph() throws IOException, TranscoderException {
        InputStream in = new FileInputStream("D:\\test\\2222222222222222222.docx");
