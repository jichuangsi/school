...
import com.jichuangsi.school.statistics.model.classType.TestStudentModel;
...
public class QuestionResultServiceImpl implements IQuestionResultService {
    ...
    @Override
    public TestStudentModel getClassStudentCapability(SearchStudentCapabilityModel model)throws QuestionResultException {
